...
![miscadmin](https://media.githubusercontent.com/media/aem-design/aem.design/gh-pages/assets/images/akamai-flush-agent/akamai-replication-miscadmin.png)

2. Click new from tool bar and you will see the Create Page dialog.
   
![create new agent](https://media.githubusercontent.com/media/aem-design/aem.design/gh-pages/assets/images/akamai-flush-agent/akamai-create-agent.png)
...
![settings tab](https://media.githubusercontent.com/media/aem-design/aem.design/gh-pages/assets/images/akamai-flush-agent/akamai-settings-tab.png)

![config_tab](https://media.githubusercontent.com/media/aem-design/aem.design/gh-pages/assets/images/akamai-flush-agent/akamai-config-tab.png)

6. You should be able to see the Akamai Flush Agent is On (green) and it will look for any replication events.
   
![success](https://media.githubusercontent.com/media/aem-design/aem.design/gh-pages/assets/images/akamai-flush-agent/akamai-enabled-agent.png)
