var store = [{
        ...
        "tags": [],
        "url": "http://aem.design/contributing/",
        "teaser":null},{
        "title": "License",
        ...
        "tags": [],
        "url": "http://aem.design/component-timing/",
        "teaser":null},{
        "title": "Manifesto",
        ...
        "tags": [],
        "url": "http://aem.design/manifesto/introduction/",
        "teaser":null},{
        ...
        "tags": [],
        "url": "http://aem.design/manifesto/principles/",
        "teaser":null},{
        "title": "Capabilities",
        ...
        "tags": [],
        "url": "http://aem.design/manifesto/capabilities/",
        "teaser":null},{
        ...
        "tags": [],
        "url": "http://aem.design/manifesto/delivery/",
        "teaser":null},{
        "title": "Project Guide",
        ...
        "tags": [],
        "url": "http://aem.design/manifesto/project/",
        "teaser":null},{
        ...
        "tags": [],
        "url": "http://aem.design/manifesto/content/",
        "teaser":null},{
        ...
        "tags": [],
        "url": "http://aem.design/manifesto/technical/",
        "teaser":null},{
        "title": "Manual",
        "excerpt":"AEM.Design Framework Documentation Document Purpose The purpose of this document is to introduce you to the AEM Platform and of its related projects, tools and processes. This knowledge is required to maintain and extend the AEM Platform. Table of Contents                                                                                                                   Projects                                                                      Development Tools                                                                      Management                                                                      Operating Environment                                                                      Process                                            ","categories": ["info"],
        "tags": ["docs"],
        "url": "http://aem.design/manual/",
        "teaser":null},{
        "title": "Manual",
        ...
        "tags": ["docs"],
        "url": "http://aem.design/manual/projects/",
        "teaser":null},{
        "title": "Manual",
        ...
        "tags": ["docs"],
        "url": "http://aem.design/manual/devtools/",
        "teaser":null},{
        "title": "Manual",
        "excerpt":"On This Page Management Jenkins Operations fstrim (environment) Oak Compaction (environment) Shutdown (environment) Startup (environment) Teardown (environment) Packages aemdesign-aem build (develop) aemdesign-aem build (release) aemdesign-aem build (final) aemdesign-aem deploy (environment) Playbooks Site Playbook (develop|sit|staging|training|uat) Playbooks Production Startup (Production) Shutdown (Production) Site Playbook (Production) Nexus Configuring Nexus Maven Repositories Docker Registries...","categories": ["info"],
        "tags": ["docs"],
        "url": "http://aem.design/manual/management/",
        "teaser":null},{
        "title": "Manual",
        "excerpt":"On This Page Operating Environment Server Red Hat Enterprise Linux IPTables Thin Pool Thin Volume Management Docker Convoy Volume Plugin List Managed Volumes Create Volume Delete Volume Docker Images Updating Docker Images Consul Registrator Operating Environment Server Red Hat Enterprise Linux The following sections details the configuration of Red Hat...","categories": ["info"],
        "tags": ["docs"],
        "url": "http://aem.design/manual/osenv/",
        "teaser":null},{
        "title": "Manual",
        "excerpt":"On This Page Processes Git Flow Versioning Testing Environments Processes Git Flow The project source code is managed with Git Flow as the release management strategy. In Git Flow, there are three main branches: /develop /master /release/[build_number] The develop branch contains features that will be deployed in the next release...","categories": ["info"],
        "tags": ["docs"],
        "url": "http://aem.design/manual/process/",
        "teaser":null},{
        ...
        "tags": ["journey","start"],
        "url": "http://aem.design/blog/2016/11/04/it-begins",
        "teaser":null},{
        ...
        "tags": ["project","update"],
        "url": "http://aem.design/blog/2017/04/06/project-introduction",
        "teaser":null},{
        ...
        "tags": ["testing","update"],
        "url": "http://aem.design/blog/2017/06/28/automation-testing",
        "teaser":null},{
        ...
        "tags": ["devops","update"],
        "url": "http://aem.design/blog/2017/07/04/devops-automation",
        "teaser":null},{
        ...
        "tags": ["devops","update"],
        "url": "http://aem.design/blog/2017/12/06/touch-ui-migration",
        "teaser":null},{
        "title": "Touch UI Test",
        ...
        "tags": ["testing","update"],
        "url": "http://aem.design/blog/2017/12/29/touch-ui-test",
        "teaser":null},{
        "title": "Touch UI Test",
        ...
        "tags": ["update"],
        "url": "http://aem.design/blog/2019/01/01/2018-came-and-went",
        "teaser":null},{
        ...
        "tags": ["update"],
        "url": "http://aem.design/blog/2019/02/02/simple-to-understand-easy-to-follow",
        "teaser":null},{
        ...
        "tags": ["update"],
        "url": "http://aem.design/blog/2019/04/04/migration-from-jsp-to-sightly",
        "teaser":null},{
        "title": "Open source is for feedback",
        "excerpt":"Open source is at the core of AEM. Supporting community is core principle of AEM.Design. AEM Design has always been about providing principled design patterns for AEM, that work in practice.Our components are tested though practice and implemented so that you can use them the way you want.We aim at...","categories": ["blog"],
        "tags": ["update"],
        "url": "http://aem.design/blog/2019/06/05/open-source-is-for-feedback",
        "teaser":null},{
        "title": "Docker Containers Everywhere",
        "excerpt":"Docker is your best friend when it comes to AEM! Yes there are so many countless ways of running AEM instances.But AEM will always be better with Docker. AEM in docker allows you to run multiple instances of AEM at a drop of a hat. No need to copy files...","categories": ["blog"],
        "tags": ["devops","aem","docker","dispatcher"],
        "url": "http://aem.design/blog/2019/07/01/docker-containers-everywhere",
        "teaser":null},{
        ...
        "url": "http://aem.design/blog/2019/07/05/docker-automation-testing",
        "teaser":null},{
        ...
        "url": "http://aem.design/blog/2019/08/30/docker-aem-bundle",
        "teaser":null},{
